  ...
  
{
  ...
  input.position(displayWidth/4 -18,displayHeight/3 +100);
  input.style('background',"white");
 
  
  button1 = createButton("Enter");
  button1.position(displayWidth/4 + 182,displayHeight/3+100);

  

  boyb = createImg('Boy1.png');
  boyb.position(displayWidth/2 - 680,displayHeight/2-310);
  boyb.size(90, 150);
  boyb.style('font-size', '25px');
  girlb = createImg('Girl1.png');
  girlb.position(displayWidth/2 - 400,displayHeight/2-310);
  girlb.size(90, 150);
  girlb.style('font-size', '25px');
  robotb = createImg('Robot1.png');
  robotb.position(displayWidth/2 - 150,displayHeight/2-310);
  robotb.size(150, 130);
  ...
  iboy = createSprite(-1277, -1640, 60, 70);
  iboy.shapeColor = "DimGrey";
  igirl = createSprite(-1183, -1640, 60, 70);
  igirl.shapeColor = "DimGrey";
  irobot = createSprite(-1090, -1640, 60, 70);
...
if (gameState!=="enter"){
 ...
 { 
  ...
  fill(222, 222, 222);
    ...
    textSize(8);
    text("Please pick a character and enter your name!", -1265, -1550);
  ...
  if(Player.x < 1900 && go === 0 && gameState !== "enter"){
    ...
    //text(tt3, -1100, -1630);
      ...
      text(tt5, camera.position.x + 170, camera.position.y + 100);
  }
