  ...
  
{
  ...
  eWall1.shapeColor = "DarkGreen";
  eWall2 = createSprite(550, -150, 1800, 300);
  eWall2.shapeColor = "DarkGreen";
  eWall3 = createSprite(1350, 350, 300, 700);
  eWall3.shapeColor = "DarkGreen";
  eWall4 = createSprite(550, 825, 1800, 300);
  eWall4.shapeColor = "DarkGreen";
  ...
  input.position(width/2 - 170,(height/2+height/4));
  input.size(200, 40);
  ...
  button1.position(width/2 + 80,(height/2+height/4 + 1));  
  button1.size(100, 45);
  ...
  buttonC.position(width/2 - width/10 - 50,(height/2+height/3));  
  buttonC.size(100, 40);
  buttonC.style('font-size', '20px');
  buttonP = createButton("Phone");
  buttonP.position(width/2 + width/10 - 50,(height/2+height/3));  
  buttonP.size(100, 40);
  ...
  hid.position(width/2 - 420, height/2 + height/3 + 50);
  heading2.style('font-size', '35px');
...
//
  ...
  //igirl.shapeColor = "DarkGreen";
  //irobot = createSprite((width/2+width/2), height/2, 60, 70);
  //irobot.shapeColor = "DarkGreen";
